export default {
  ...
  globalNotify: {
    ...
    share: {
      title: 'Share',
      expiresValue: 'Expiration duration',
      expiresValueEmpty: 'Expiration duration cannot be empty',
      expiresValuePlaceholder: 'Please enter expiration duration',
      expiresValueRegex: 'Please enter a number from 0.01 to 99999.99',
      expiresUnit: 'Expiration unit',
      token: 'Custom Token',
      tokenPlaceholder: 'Default backend random Token',
      remark: 'Remark',
      remarkPlaceholder: 'Please enter a remark',
      shareUrl: 'Share link',
      shareUrlPlaceholder: 'Please click the button to create a share link',
      tipsTitle: 'Tips',
      userKnow: 'I understand',
      confirm: 'Confirm',
      cancel: 'Back',
      createShare: 'Create share',
      copyShare: 'Copy link',
      copyShareSuccessTips: 'Share link copied!',
      createShareSuccessTips: 'Share created!',
      unit: {
        day: 'Day',
        month: 'Month',
        season: 'Season',
